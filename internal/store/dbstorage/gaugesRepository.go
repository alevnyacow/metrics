...
func (repository *GaugesRepository) PrepareDB(ctx context.Context) {
...
func (repository *GaugesRepository) GetValue(ctx context.Context, key domain.GaugeName) domain.GaugeValue {
	data := repository.Get(ctx, key)
	return data.Value
}

func (repository *GaugesRepository) Exists(ctx context.Context, key domain.GaugeName) bool {
	gauge := repository.Get(ctx, key)
	return gauge.Name == key
}
